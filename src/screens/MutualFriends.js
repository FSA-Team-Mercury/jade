        ...
        return (
          <View style={friend.container} key={index}>
            <View style={friend.levelOne}>
              <View style={friend.badgeImageContainer}>
                <Image
                  source={require("../../assets/images/icons8-rihanna-96.png")}
            ...
            <View style={friend.levelThree}>
              <View style={friend.followedBy}>
                <View style={friend.friend}>
                  <Image
                    source={require("../../assets/images/icons8-ozil-96.png")}
                    style={friend.friendImage}
                  />
                </View>
                <View style={friend.friend}>
                  <Image
                    source={require("../../assets/images/icons8-salah-96.png")}
                    style={friend.friendImage}
                  />
                </View>
              </View>
              <TouchableOpacity style={friend.follow}>
                <Text>Follow</Text>
              </TouchableOpacity>
            </View>
          </View>
